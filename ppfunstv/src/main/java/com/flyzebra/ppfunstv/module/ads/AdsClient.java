...
public class AdsClient {
    private static final Uri URI = Uri.parse("content://com.flyzebra.adservice.ADprovider");
    private static final Uri URITable = Uri.parse("content://com.flyzebra.adservice.ADprovider/ad_info_table");
    ...
    public static InputStream getADfile(Context mContext, String adurl) throws IOException {
        ...
        Uri uri = Uri.parse("content://com.flyzebra.adservice.ADprovider/" + split[split.length-1]);
