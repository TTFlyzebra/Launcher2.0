...
public class LivePlayHelper {
    ...
    public static final String ACTION_STOP = "com.ppfuns.liveplay.ACTION_STOP";//停止播放
    public static final String ACTION_PLAY = "com.ppfuns.liveplay.ACTION_PLAY";//開始播放
    public static final String ACTION_BOUNDS = "com.ppfuns.liveplay.ACTION_SET_BOUNDS";//设置显示位置
    ...
    public final String ACTION_RESPONSE = "com.ppfuns.liveplay.ACTION_RESPONSE";
    public final String ACTION_CA = "com.ppfuns.liveplay.ACTION_CA_RESPONSE";//
