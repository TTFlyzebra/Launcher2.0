...
import com.ppfuns.ppfunstv.module.player.MediaPlayerFactory;
...
public class SuperVideoView extends SurfaceView {
    ...
    public CharSequence getAccessibilityClassName() {
        return SuperVideoView.class.getName();
    }
    ...
    private void openVideo() {
        ...
        try {
            mMediaPlayer = MediaPlayerFactory.getInstance()
                    .getMediaPlayer(MediaPlayerFactory.ANDROID_MEDIAPLAYER);
    ...
    IMediaPlayer.OnVideoSizeChangedListener mSizeChangedListener =
            new IMediaPlayer.OnVideoSizeChangedListener() {
                ...
                public void onVideoSizeChanged(IMediaPlayer mp, int width, int height) {
                    ...
                    Log.i(TAG, "mSizeChangedListener:" + mVideoWidth +"/"+ mVideoHeight);
                }
            };
