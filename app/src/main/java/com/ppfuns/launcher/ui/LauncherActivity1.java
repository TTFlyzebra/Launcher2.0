...
import com.ppfuns.launcher.service.AAAServiceConnect;
...
import com.ppfuns.ppfunstv.view.TvView.PopupTV.PopupTvView;
...
//                headEntity.showFilter = false;
//            }
//            String serarchActionJson = "{'intent':'com.ppfuns.vod.action.ACTION_VIEW_SEARCH','data':'','cmd':''}";
...
//                    shade.setVisibility(View.GONE);
    ...
    public void finish() {
        ...
        super.finish();
        //关闭窗体动画显示
//        this.overridePendingTransition(com.ppfuns.ppfunstv.R.anim.tv_anim_activity_exit,com.ppfuns.ppfunstv.R.anim.tv_not_anim);
        this.overridePendingTransition(android.R.anim.fade_in, com.ppfuns.ppfunstv.R.anim.tv_anim_activity_exit);
    }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_CLOSE_SYSTEM_DIALOGS)) {
                ...
                if (SYSTEM_DIALOG_REASON_HOME_KEY.equals(reason)) {
                    ...
                    finish();
//                    overridePendingTransition(com.ppfuns.ppfunstv.R.anim.tv_not_anim,com.ppfuns.ppfunstv.R.anim.tv_anim_activity_exit);
