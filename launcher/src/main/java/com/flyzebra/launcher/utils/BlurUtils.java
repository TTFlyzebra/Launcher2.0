...
/**
 * Created by 李冰锋 on 2016/7/6 17:41.
 * E-mail:libf@ppfuns.com
 * Package: com.flyzebra.launcher.utils
 */
public class BlurUtils {
    public final static String TAG = BlurUtils.class.getSimpleName();
...
//        Bitmap tmpBitmap = Bitmap.createBitmap(bitmap,0,0,bitmap.getWidth()/2, bitmap.getHeight()/2);
