...
public class GaussBlurUtils {
    ...
    public static void blur2(Context context, Bitmap bkg, View view) {
        ...
        Log.i("", "time = " + (System.currentTimeMillis() - startMs) + " ms");
    }


    public static Bitmap blur2(Context context, Bitmap bkg) {
        float radius = 15;
        float scaleFactor = 3f;
