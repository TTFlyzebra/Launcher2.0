...
public class CaReceiver extends BroadcastReceiver {
    private static final String YINHE_CARD_OUT = "com.flyzebra.ngb.action.SMARTCARDPULLOUT";
    private static final String YINHE_CARD_IN = "com.flyzebra.ngb.action.SMARTCARDINSERT";
    private static final String PPFUNS_CARD_CHANGED = "com.flyzebra.ca.changed";
