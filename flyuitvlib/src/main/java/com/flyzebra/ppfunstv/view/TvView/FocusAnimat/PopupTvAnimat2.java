 ...
 */
public class PopupTvAnimat2 implements ITvFocusAnimat {
    ...
    public PopupTvAnimat2(ViewGroup viewGroup) {
        rootView = viewGroup;
    ...
    public void flyWhiteBorder(IAnimatView view, Rect rect1, Rect rect2, boolean isMoveCenter) {
        ...
        shadowView.layout(rect2.left - shadowAmend, rect2.top - shadowAmend, rect2.right + shadowAmend, rect2.bottom + shadowAmend);
...
//                from_height = from_height + mAnimCount.get() * (to_height - from_height) / num;
        ...
        private void finishAnimate() {
            ...
            mHandler.post(new Runnable() {
                @Override
                public void run() {
                    PopupTvAnimat2.this.shadowView.bringToFront();
                    if (objView.getFocusZorder() == 1) {
                        ((View)objView).bringToFront();
                    }
                }
